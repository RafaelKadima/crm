...
import {
  useChannelWhatsAppProfile,
  useUpdateChannelWhatsAppProfile,
  useUploadChannelWhatsAppProfilePhoto,
  useWhatsAppProfileCategories,
  type UpdateProfileData,
} from '@/hooks/useChannelWhatsAppProfile'

interface ChannelWhatsAppProfileEditorProps {
  channelId: string
  open: boolean
  onOpenChange: (open: boolean) => void
}

export function ChannelWhatsAppProfileEditor({
  channelId,
  open,
  onOpenChange,
}: ChannelWhatsAppProfileEditorProps) {
  const { data: profile, isLoading: loadingProfile } = useChannelWhatsAppProfile(channelId)
  const { data: categories } = useWhatsAppProfileCategories()
  const updateMutation = useUpdateChannelWhatsAppProfile()
  const uploadPhotoMutation = useUploadChannelWhatsAppProfilePhoto()
