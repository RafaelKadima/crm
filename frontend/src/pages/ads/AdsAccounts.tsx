  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        ...
        subtitle="Gerencie suas contas Meta Ads e Google Ads"
        actions={
              ...
              <div className="mt-4 space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className={`font-medium ${
                    ...
                    account.status === 'error' ? 'text-red-600' : 'text-muted-foreground'
                  }`}>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button
                  ...
                  disabled
                  className="p-4 rounded-lg border-2 border-gray-200 dark:border-border flex flex-col items-center gap-2 opacity-50 cursor-not-allowed"
                >
                  <div className="w-10 h-10 bg-gray-300 rounded-lg flex items-center justify-center">
                    <span className="text-muted-foreground font-bold text-lg">G</span>
                  </div>
