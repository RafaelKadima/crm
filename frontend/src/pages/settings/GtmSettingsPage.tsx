    ...
    <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between p-4 bg-accent/30 rounded-lg">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Habilitar o rastreamento de eventos no GTM</p>
            </div>
            <button
              onClick={() => setFormData({ ...formData, gtm_enabled: !formData.gtm_enabled })}
              className={`relative w-14 h-7 rounded-full transition-colors ${
                formData.gtm_enabled ? 'bg-blue-600' : 'bg-muted-foreground/20'
              }`}
            >
              <div
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="bg-accent/30 rounded-lg p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              <li><code className="text-xs bg-muted px-1 rounded">lead_id</code> - ID do lead</li>
              <li><code className="text-xs bg-muted px-1 rounded">lead_source</code> - Origem</li>
              <li><code className="text-xs bg-muted px-1 rounded">value</code> - Valor (R$)</li>
              <li><code className="text-xs bg-muted px-1 rounded">currency</code> - Moeda (BRL)</li>
            </ul>
          </div>
          ...
          <div className="bg-accent/30 rounded-lg p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              <li><code className="text-xs bg-muted px-1 rounded">contact_email</code> - Email</li>
              <li><code className="text-xs bg-muted px-1 rounded">contact_phone</code> - Telefone</li>
              <li><code className="text-xs bg-muted px-1 rounded">contact_first_name</code> - Nome</li>
              <li><code className="text-xs bg-muted px-1 rounded">contact_last_name</code> - Sobrenome</li>
              <li><code className="text-xs bg-muted px-1 rounded">contact_city</code> - Cidade</li>
            </ul>
          </div>
          ...
          <div className="bg-accent/30 rounded-lg p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              <li><code className="text-xs bg-muted px-1 rounded">stage_from</code> - Estágio anterior</li>
              <li><code className="text-xs bg-muted px-1 rounded">stage_to</code> - Estágio atual</li>
              <li><code className="text-xs bg-muted px-1 rounded">pipeline_name</code> - Pipeline</li>
            </ul>
          </div>
          ...
          <div className="bg-accent/30 rounded-lg p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              <li><code className="text-xs bg-muted px-1 rounded">utm_source</code></li>
              <li><code className="text-xs bg-muted px-1 rounded">utm_medium</code></li>
              <li><code className="text-xs bg-muted px-1 rounded">utm_campaign</code></li>
              <li><code className="text-xs bg-muted px-1 rounded">utm_term</code></li>
              <li><code className="text-xs bg-muted px-1 rounded">utm_content</code></li>
            </ul>
          </div>
          ...
          <div className="bg-accent/30 rounded-lg p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              <li><code className="text-xs bg-muted px-1 rounded">content_type</code></li>
              <li><code className="text-xs bg-muted px-1 rounded">content_name</code></li>
              <li><code className="text-xs bg-muted px-1 rounded">content_category</code></li>
            </ul>
          </div>

          {/* Meta */}
          <div className="bg-accent/30 rounded-lg p-4">
            <h4 className="font-medium text-muted-foreground mb-2">Metadados</h4>
            <ul className="text-sm space-y-1 text-muted-foreground">
              <li><code className="text-xs bg-muted px-1 rounded">event_time</code> - Timestamp</li>
              <li><code className="text-xs bg-muted px-1 rounded">tenant_id</code> - ID empresa</li>
              <li><code className="text-xs bg-muted px-1 rounded">user_id</code> - Vendedor</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-6">
        ...
        <div className="mt-4 p-4 bg-muted/50 rounded-lg">
          <p className="text-xs text-muted-foreground mb-2">Exemplo completo de evento disparado:</p>
  ...
  return (
    <div ref={containerRef} className="relative">
      <input
        ...
        className="w-full px-3 py-1.5 bg-accent border border-border rounded text-sm focus:border-blue-500 focus:outline-none"
      />
      ...
      <AnimatePresence>
        {isOpen && filteredSuggestions.length > 0 && (
          <motion.div
            ...
            className="absolute z-50 top-full left-0 right-0 mt-1 bg-muted border border-border rounded-lg shadow-xl overflow-hidden max-h-48 overflow-y-auto"
          >
